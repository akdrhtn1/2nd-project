            ...
            <div class="copntainer--main">
                <div class="nav">
                    <ul class="procedure">
                        ...
                        <li><a href="admin?type=question">문의사항관리</a></li>
                        <li>문의사항상세조회</li>
                    </ul>
                </div>  
                ...
                <section class="subInner">
				 ...
				 <table>
                        ...
                        <div>
       						<a class="btn1" href ="admin?type=qdelete&qIdx=${one.qIdx }">삭제</a>
							<a class="btn2" href ="admin?type=question" > 목록보기</a>
                        </div>
                    </div>
                </section>
