...
<body>
     <div class="wrap">
         <div class="wrap-header">
            <div class="header-title">
                <div class="header-block">
                    ...
                    <div class="back-icon">
                       <a href="board?type=momBoard"> <img src="https://cdn.mom-sitter.com/momsitter-app/static/public/svg/backward.svg"></a>
                    </div>
                </div>
            </div>
         ...
         <div class="img-tag">
            ...
            <img id="fileImage" class="fileImage" src="img/baby.png" alt="프로필 이미지" tabindex="-1" style="display: inline-block;">
         </div>
         ...
         <div>
            <div class="padding-box">
                <div class="padding-top">
                    <div class="textbox">
                        <div class="name">${momOne.name }</div>
